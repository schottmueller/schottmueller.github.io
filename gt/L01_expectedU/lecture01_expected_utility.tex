...
\begin{itemize}
\item course website:\\ \url{https://schottmueller.github.io/gt/gt2015.html}
...
\item related other courses:\\ many other courses use game theory tools
  \begin{itemize}
   ...
   \item \dots
  \end{itemize}
\item lecture schedule: \url{https://schottmueller.github.io/gt/lectureplan2015.html}%\href{run:/home/christoph/SpiderOak Hive/game theory/lectureplan2014.html}{course plan}
\end{itemize}
}
...
* reading: Aumann ``What is Game Theory trying to accomplish?'' (link on website), MWG p. 178--182
}
...
\item Prove the strict preference part of the lemma on slide 17.
  \end{enumerate}
}
