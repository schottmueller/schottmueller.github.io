...
When you have thought through the questions above, you write up a one page research proposal (summing up your thoughts/answers) and send this proposal to me. It should contain your main question, answers to (some of) the questions above (1.2), and some first ideas regarding the methods with which you want to tackle the problem. I will read it and then we meet to discuss the proposal (or I refer you to a colleague of mine if your proposal is completely out of my own field of expertise). We might conclude that the proposal should be changed a bit or we might immediately go ahead.
...
- I want to see a proposal (~1 page); preferably before meeting for the first time. /If we meet before you have a proposal, I usually cannot tell you more than is written in this document, i.e. we both waste our time./ I will not sign a thesis contract if you do not have a clear proposal because it would be irresponsible to let you commit to something without having a clear idea of what to do.
...
- Make sure to use some tool(s) that is (are) taught in a Master course you took (and that are not aught in Bachelor courses as well). This way you avoid writing a thesis that is not at the Master level.
...
- You do yourself and your readers a favor if you write in LaTeX (and use BibTeX). The LaTeX [[https://en.wikibooks.org/wiki/LaTeX][wikibook]] will be a great ressource in this case.
