...
@@html: <br/><span class="tab"> <font size="2"> <a href="./papers/msInfo/binary.jl">code</a> for binary type space, <a href="./papers/msInfo/MSOptWebsite.jl">code</a> for uniform type distribution</font> </span>@@
...
Too good to be truthful: Why competent advisers are fired [[./papers/dynAdvReputation/reputation.pdf][paper]] [[./papers/dynAdvReputation/supMatReputation.pdf][supplementary material]], /Journal of Economic Theory/  [[https://doi.org/10.1016/j.jet.2019.03.006][doi]], Vol. 181, May 2019, pp. 333--360
...
@@html: <br/> <span class="tab"> <font size="2">supplementary material: <a href="papers/endogenous_info/Continuum-Round2-sup-mat-v2.pdf">here</a>, Python code: <a href="papers/endogenous_info/current_example1113.py">here</a> and <a href="papers/endogenous_info/current_example_1113_discont_graph.py" target="_blank">here</a> </font> </span> @@
