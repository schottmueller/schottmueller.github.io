...
%
\begin{itemize}   
\item Health provider networks, quality and costs (with Jan Boone), accepted for publication in the \emph{International Economic Review}

\item An informational theory of privacy (with Ole Jann), accepted for publication in the \emph{Economic Journal}
...
\item Competing with big data (with Jens Pr\"ufer)
...
\item member of PhD committees: Johannes Viehmann (University of Cologne, 2019), Johannes Wagner (University of Cologne, 2018), J\"orgen Kratz (Lund University, 2018), Sebastian Dengler (Tilburg University, 2017), Xu Lang (Tilburg University, 2016)
\end{itemize}
