...
* News
- There are no exercise sessions in person between November 19 and Christmas. You find instead screencasts on the exercises [[https://uni-koeln.sciebo.de/s/56fEiNw6DKF5Kq9][here]] (some might be added later) and have the possibility to ask questions on those in January.
