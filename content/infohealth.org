...
* News
- The optional exam inspection will take place jointly for both exam dates in April (precise date and registration will be announced later).
- Calculators for the exam: Calculators are allowed if they are (i) not graphical, (ii) cannot solve equations and (iii) cannot solve optimization problems. (Any freebie calculator that can add, multiply and take roots will do. In fact, it is possible to solve the exam without using a calculator.)
- The results of the bonus point assignment are [[https://uni-koeln.sciebo.de/s/GA3ewHqnPfrEHXd][available]].
- There are no exercise sessions in person between November 19 and Christmas. You find instead screencasts on the exercises [[https://uni-koeln.sciebo.de/s/56fEiNw6DKF5Kq9][here]] and have the possibility to ask questions on those in two zoom sessions (December 22, 11:00 and January 5, 11:00; see email in your university mail account for zoom links).
...
- Exam dates are Feb 4, 14:30 (100 Hörsaal VIII) and March 17, 10:00 (100 Aula 2 100/01/Aula 2). Registration is open on KLIPS. We will try to grade the exams of the first date before the registration deadline of the second but we cannot guarantee that we will manage (we managed in previous years).
...
#  - The post exam review (for both exam dates) is announced. Further information about how to register can be found [[https://wiso.uni-koeln.de/de/studium/studienorganisation/klausureinsichtnahmen/mikrooekonomik][here]].
  - Note that there will be a first exercise session on October 15. This exercise session is dedicated to repeating some mathematical concepts used in this course.
...
Please note that I do not use ILIAS because (i) I did not agree with certain usage conditions concerning tracking and data utilization and (ii) I want to make the material I create publicly available. The material below might get updated over the course of the term.

# You can find the source code creating the slides as Emacs org-mode files (".org") [[https://github.com/schottmueller/infohealthecon/tree/master/slides][here]].
#
# - The *course plan* as [[https://github.com/schottmueller/infohealthecon/files/5299046/plan.pdf][pdf]].

- *Exercises*: first week [[https://github.com/schottmueller/infohealthecon/files/3685313/Exercise.Sheet.1.pdf][here]], further weeks [[https://uni-koeln.sciebo.de/s/rff2zsPa6wkKRQE][here]]

- [[https://uni-koeln.sciebo.de/s/56fEiNw6DKF5Kq9][Screencasts]] of exercise session not held in person 

- *Bonus point exercises*: [[https://uni-koeln.sciebo.de/s/EaHJwdQf5LEGGZF][here]] (solutions must be handwritten and submitted in the lecture December 17) 
  
- *Slides*: [[https://uni-koeln.sciebo.de/s/sPsTPfBcY2rS9kS][here]]
...
- *Data sets and instructions* for case studies:
  - questions (as pdf) and datasets for the empirical lectures are [[https://uni-koeln.sciebo.de/s/BbIdIvP12FE6wLW][here]] available for download
  - some [[https://uni-koeln.sciebo.de/s/ApZRZk3pL55yCAD][notes]] on longterm care insurance case study
...
- *Notes*
  - [[https://uni-koeln.sciebo.de/s/oaiXnh8H6uPdp25][notes]] (book project -- only some parts are relevant!; password announced in lecture) 
  - optional [[https://uni-koeln.sciebo.de/s/tRyH9Jbz2pW4rWY][math]] notes
# password: infohealthecon    
...
** Lecture times: 
- lecture: Wednesday, 10:00-11:30 in 100/U1/HS V
- exercise classes: Wednesday, 14:00-15:30 100/U1/HS VIII 
