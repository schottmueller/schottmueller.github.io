...
* Course setup
  ...
  *Prerequisites:* You are expected to know basic game theory (normal form games, dominant strategies, Nash equilibrium, game trees, subgame perfect Nash equilibrium) and microeconomics at Bachelor level (preferences, indifference curves, utility functions, consumer problem, Pareto efficiency).
  # The  [[https://web.tresorit.com/l/M1vPF#qsgBnSpLwC1xwq2yNER_jA][schedule]] contains detailed prerequisites for each lecture in terms of economics and mathematics.
* Material
...
|    2 | markets, prices, equilibrium      |           | consumer problem, marginal rate of substitution, constrained optimization               |
|    3 | decision making under uncertainty |           | discrete probability distribution, expected value, concavity and convexity of functions |
