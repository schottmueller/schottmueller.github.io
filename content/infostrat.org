...
* News
 - Slides and handouts of student presentations can be found [[https://web.tresorit.com/l/LXOjX#duQ2IpeV3UgpaxgA6m0Stg][here]]. (same password as for lecture notes)
 - The paper we discuss on Dec. 18 can be downloaded [[https://doi.org/10.1016/j.jet.2019.03.006][here]] (you need a vpn to the campus or be on campus to download).
 - The paper we discuss on Nov. 20 can be downloaded [[https://schottmueller.github.io/papers/echoChamber/echo_chambers.pdf][here]].
 - The paper we discuss on Nov. 13 can be downloaded [[https://doi.org/10.1287/mnsc.2017.2913][here]] (you need a vpn to the campus or be on campus to download). 
 - The paper we discuss on Oct. 23 can be downloaded [[http://dx.doi.org/10.1016/j.jmateco.2015.01.005][here]] (you need a vpn to the campus or be on campus to download). 
...
** Slides of student presentations
 - You can find the slides [[https://web.tresorit.com/l/LXOjX#duQ2IpeV3UgpaxgA6m0Stg][here]]. (same password as for lecture notes)
