...
* News
- The lecture on June 11 is rescheduled to June 10 4pm, room SSC 4.210. 
- We will no longer follow the screencasts in the remainder of the course. Please, read one chapter before every session from the [[https://uni-koeln.sciebo.de/s/AFD8Fregy2D4rA2][notes]] instead (pw announced in lecture). Exercises covered are as follows:
  | topic                     | exercises |
  |---------------------------+-----------|
  | Signaling                 | 2,4,5,6   |
  | Mech Des: Concepts        | 1,2,5,6   |
  | Mech Des: Public good     | 1,5,7,9   |
  | Mech Des: Bilateral trade | 1,2,3,6  |
...
- [[https://uni-koeln.sciebo.de/s/AFD8Fregy2D4rA2][link]] to reading material (password announced in lecture)
 # micromer  
